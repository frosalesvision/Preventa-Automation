...
PARES_VERIFICADOS_MANUALMENTE = [
    ('PAR-P8PTZXIR32NH-AI', 'WV-QWL502-W', 'i-PRO Wall or Pole Mount Bracket', 'Panasonic i-PRO',
     'Visto en cotizacion real (Municipalidad Alajuelita, proyecto Ciudad Segura, 2026) -- Paramont no tenia mount propio para esta PTZ, se uso un bracket universal de Panasonic i-PRO. No esta en nuestro catalogo de proveedores todavia, hay que cotizarlo aparte.'),
    ('PAR-P8PTZXIR32NH-AI', 'WV-QPL500-W', 'i-PRO Pole Mount Bracket', 'Panasonic i-PRO',
     'Visto en cotizacion real (Municipalidad Alajuelita, 2026) -- mismo caso que WV-QWL502-W, no esta en nuestro catalogo todavia.'),
    ('PAR-P8PTZXIR32NH-AI', 'WV-QSR503-W', 'i-PRO Shroud Bracket (4 holes)', 'Panasonic i-PRO',
     'Visto en cotizacion real (Municipalidad Alajuelita, 2026). No esta en nuestro catalogo todavia.'),
    ...
    ('PAR-P8PTZXIR32NH-AI', 'SBD-180PMW', 'Pole Mount', 'Hanwha',
     'Visto en cotizacion real (Municipalidad Alajuelita, 2026) -- OJO: la ficha de Hanwha de este mount NO lista modelos Paramont como compatibles, el equipo lo uso igual en la practica. Verificar que encaje fisicamente antes de repetirlo.'),
